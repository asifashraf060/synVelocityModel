...
if srGeometry.tf_latlon == 1
    ...
    alt     = 0;
    lat0rad = deg2rad(srGeometry.latitude);
    lon0rad = deg2rad(srGeometry.longitude);

    [x,y,z] = enu2ecef(x,y,zeros(size(x)),lat0rad,lon0rad,alt,srGeometry.ellipsoid, 'radians');
